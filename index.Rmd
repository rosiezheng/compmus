...
These tempograms show the tempo analysis from the Borderless song "Abandoned". Both temporgrams are Fourier-based and therefore stronly tend to pick up on tempo harmonics. Sometimes it can be more informative to wrap this into a cyclic tempogram. The lower tempogram shows such a cyclic tempogram. 
